      ...
      <div className="container mx-auto container-padding py-24">
        <div className="max-w-4xl mx-auto prose prose-lg">
          ...
          <div className="space-y-8 text-foreground leading-relaxed">
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">1. Description of Service</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">2. User Accounts</h2>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">3. User Responsibilities</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">4. Intellectual Property</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">5. Confidentiality</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">6. Data Privacy</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">7. Disclaimers</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">8. Limitation of Liability</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">9. Indemnification</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">10. Governing Law</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">11. Changes to Terms</h2>
              <p>
            ...
            <div>
              <h2 className="font-serif text-2xl font-medium mb-4 text-foreground">12. Contact Us</h2>
              <p>
