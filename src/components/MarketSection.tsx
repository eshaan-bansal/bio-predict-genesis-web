        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm neo-glass overflow-hidden">
            ...
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold mb-2 gradient-text">$100 Billion Total Addressable Market (TAM)</h3>
              <ul className="space-y-3 mt-4 text-sm">
                <li className="flex items-start">
                  <span className="h-1.5 w-1.5 rounded-full bg-biopredict-light-purple mt-1.5 mr-2 flex-shrink-0"></span>
                  <span>Represents the global biopharmaceutical manufacturing sector's vast expenditure and the immense financial burden of current inefficiencies.</span>
                </li>
                <li className="flex items-start">
                  <span className="h-1.5 w-1.5 rounded-full bg-biopredict-light-purple mt-1.5 mr-2 flex-shrink-0"></span>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm neo-glass overflow-hidden">
            ...
            <CardContent className="p-6">
              ...
              <h3 className="text-xl font-bold mb-2 gradient-text">$20 Billion Serviceable Addressable Market (SAM)</h3>
              <ul className="space-y-3 mt-4 text-sm">
                <li className="flex items-start">
                  <span className="h-1.5 w-1.5 rounded-full bg-biopredict-light-purple mt-1.5 mr-2 flex-shrink-0"></span>
