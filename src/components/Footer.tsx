          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                <li>
                  <button onClick={() => scrollToSection('problem')} className="hover:text-white transition-colors text-left">
                    Problem
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('platform')} className="hover:text-white transition-colors text-left">
                    Platform
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('science')} className="hover:text-white transition-colors text-left">
                    Science
                  </button>
                </li>
                <li>
                  <button onClick={() => scrollToSection('market')} className="hover:text-white transition-colors text-left">
                    Market
                  </button>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                <li>
                  <button onClick={handleRequestDemo} className="hover:text-white transition-colors text-left">
                    Request Demo
                  </button>
                </li>
                <li>
