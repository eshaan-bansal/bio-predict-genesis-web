...
const TeamSection = () => {
  return (
    <section id="team" className="py-24 relative overflow-hidden">
      ...
      <div className="absolute left-0 bottom-0 w-96 h-96 bg-primary/5 rounded-full blur-3xl -z-5"></div>
      <div className="absolute right-0 top-0 w-72 h-72 bg-accent/5 rounded-full blur-3xl -z-5"></div>
      
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-md text-primary text-xs font-medium mb-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {[1, 2, 3].map((index) => (
            <Card key={index} className="bg-white/5 backdrop-blur-sm border-primary/10 overflow-hidden">
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-accent mb-3">Position / Role</p>
                  <p className="text-sm text-accent/80 dark:text-accent/60">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="neo-glass border-primary/20 relative overflow-hidden">
