      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
          <div className="relative">
            ...
            <Card className="overflow-hidden border-0 shadow-lg h-full bg-gradient-to-br from-white to-gray-50">
              <CardContent className="p-6 md:p-8">
                <h3 className="text-xl font-sans font-bold mb-4">Manufacturing Challenges</h3>
          ...
          <div className="relative">
            ...
            <Card className="overflow-hidden border-0 shadow-lg h-full bg-gradient-to-br from-white to-gray-50">
              <CardContent className="p-6 md:p-8">
                <h3 className="text-xl font-sans font-bold mb-4">RMPredictive: AI for Smarter Manufacturing</h3>
