  ...
  return <section id="about" className="section-padding bg-white">
      <div className="container mx-auto container-padding">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {founders.map((founder, index) => <div key={founder.name} className="text-center">
              <div className="mb-6">
                <h3 className="font-serif text-2xl font-medium text-gray-900 mb-2">
                  {founder.name}
                </h3>
                <p className="text-blue-600 mb-4">Co-Founder</p>
                <a href={`mailto:${founder.email}`} className="text-gray-600 hover:text-gray-900 transition-colors">
                  {founder.email}
                </a>
              </div>
              <div className="mt-6">
